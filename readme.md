...
This part of the library contains, also - optional, include files. These are mostly used for common problems. Like including other YSI or even third party libraries and similar stuff.
